...
#SBATCH --output=output_DNS_T1_dt1e-5_X1.0001Y1.0001_lin_macheps.out		# output file
#SBATCH --job-name=DNS3            	# keep track of jobs

module restore 2DKS_modules
rm -rf DNS_T1_dt1e-5_X1.0001Y1.0001_lin_macheps
mkdir DNS_T1_dt1e-5_X1.0001Y1.0001_lin_macheps
make clean
make type=DNS
