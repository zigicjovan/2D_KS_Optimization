...
MODULE global_variables
  ...
  REAL(pr), PARAMETER         :: domain1      = 10.2_pr         ! domain size 
  REAL(pr), PARAMETER         :: domain2      = 10.2_pr         ! domain size 
  ...
  CHARACTER(len=*), PARAMETER :: str_domain1 = "10.2"
  CHARACTER(len=*), PARAMETER :: str_domain2 = "10.2" 
