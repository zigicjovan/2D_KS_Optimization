...
SUBROUTINE KS_initialize
  ...
  Lx = (2.0_pr*PI)*domain1      ! Length in the x direction
  Ly = (2.0_pr*PI)*domain2      ! Length in the y direction
...
!  DO i = 0, n_nse(1)-1
  ...
  DO i2=1,local_Nx
    DO i1=1,n_nse(2)
      ksq(i1, i2) = ( K1(i2+local_x_offset)**2 + K2(i1)**2 ) ! 2DNS linear term + negative of Laplace operator
