...
MODULE global_variables
  ...
  REAL(pr), PARAMETER         :: domain1      = 1.3_pr         ! domain size 
  REAL(pr), PARAMETER         :: domain2      = 1.3_pr         ! domain size 
  ...
  CHARACTER(len=*), PARAMETER :: str_domain1 = "1.3"
  CHARACTER(len=*), PARAMETER :: str_domain2 = "1.3" 
