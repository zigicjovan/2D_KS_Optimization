...
MODULE global_variables
  ...
  REAL(pr), PARAMETER         :: domain1      = 5.2_pr         ! domain size 
  REAL(pr), PARAMETER         :: domain2      = 5.2_pr         ! domain size 
  ...
  CHARACTER(len=*), PARAMETER :: str_domain1 = "5.2"
  CHARACTER(len=*), PARAMETER :: str_domain2 = "5.2" 
