...
#SBATCH --output=output_DNS_T200_dt1e-3_X1.2Y1.2_lin_machepssinL.out		# output file
#SBATCH --job-name=dnsT200x11y11            	# keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/scratch/2D_KS_Optimization-1/DNS_T200_dt1e-3_X1.2Y1.2_lin_machepssinL/
mkdir /home/zigicj/scratch/2D_KS_Optimization-1/DNS_T200_dt1e-3_X1.2Y1.2_lin_machepssinL/
make clean
make type=DNS
