...
#SBATCH --output=output_DNS_T150_dt1e-3_X1.5Y1.5_sineL.out	# output file
#SBATCH --job-name=DNST150X1.5Y1.5sineL            	        # keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T150_dt1e-3_X1.5Y1.5_sineL/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T150_dt1e-3_X1.5Y1.5_sineL/
make clean
make type=DNS
