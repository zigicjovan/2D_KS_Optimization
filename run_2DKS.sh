...
#SBATCH --time=00-03:30		                                # time (DD-HH:MM) or (HH:MM:SS)
#SBATCH --output=output_DNS_T1000_N128_dt1e-4_X1.40Y1.40_sineL.out	# output file
#SBATCH --job-name=DNST1000X1.40Y1.40sineL            	        # keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T1000_N128_dt1e-4_X1.40Y1.40_sineL/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T1000_N128_dt1e-4_X1.40Y1.40_sineL/
make clean
make type=DNS
...
cp -r . /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T1000_N128_dt1e-4_X1.40Y1.40_sineL/