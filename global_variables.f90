...
MODULE global_variables
  ...
  REAL(pr), PARAMETER         :: iniTime      = 0.0_pr, endTime = 100.0_pr ! Initial and final time
  ...
  CHARACTER(len=*), PARAMETER :: work_pathname    = "/home/zigicj/scratch/2D_KS_Optimization/DNS_T400_dt1e-5_X1.0Y1.0_lin_macheps/" !! beluga
