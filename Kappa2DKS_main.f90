!-----------------------------------------------------!
! Fortran code using MPI to solve the Kappa Test for  !
! for the IC optimization of the 2D Navier-Stokes     !
! system.                                             !
!                                                     !
...
PROGRAM Kappa2DKS_main
  ...
  ! Solve the forward and backward problem, to perform the Kappa Test
  CALL KappaTest(vort0)    ! Found in optimization.f90
