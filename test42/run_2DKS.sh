...
#SBATCH --output=output_DNS_T200_dt1e-3_X4.2Y4.2_machepssinN2.out		# output file
#SBATCH --job-name=dnsT200x42y42            	# keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X4.2Y4.2_machepssinN2/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X4.2Y4.2_machepssinN2/
make clean
make type=DNS
