...
rm -rf /home/zigicj/scratch/2D_KS_Optimization-1/DNS_T200_dt1e-3_X4.2Y4.2_machepsnoise/
mkdir /home/zigicj/scratch/2D_KS_Optimization-1/DNS_T200_dt1e-3_X4.2Y4.2_machepsnoise/
make clean
make type=DNS
