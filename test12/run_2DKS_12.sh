...
#SBATCH --output=output_DNS_T200_dt1e-3_X1.2Y1.2_machepsnoise.out		# output file
#SBATCH --job-name=dnsT200x12y12            	# keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X1.2Y1.2_machepsnoise/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X1.2Y1.2_machepsnoise/
make clean
make type=DNS
