...
#SBATCH --output=output_DNS_T1_dt1e-5_X1.000001Y1.000001_lin_macheps.out		# output file
#SBATCH --job-name=DNS5            	# keep track of jobs

module restore 2DKS_modules
rm -rf DNS_T1_dt1e-5_X1.000001Y1.000001_lin_macheps
mkdir DNS_T1_dt1e-5_X1.000001Y1.000001_lin_macheps
make clean
make type=DNS
