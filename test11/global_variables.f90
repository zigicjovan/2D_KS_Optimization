...
MODULE global_variables
  ...
  REAL(pr), PARAMETER         :: endTime      = 200.0_pr       ! Final time ! {<700k elts/hr} => {10m elts = 15h, 1m elts = 1h30}
  ...
  REAL(pr), PARAMETER         :: domain1      = 1.1_pr         ! domain size 
  REAL(pr), PARAMETER         :: domain2      = 1.1_pr         ! domain size 
  CHARACTER(len=*), PARAMETER :: IC_type      = "machepssinN2" ! Type of initial vorticity to use ! 2DKS
  ...
  CHARACTER(len=*), PARAMETER :: str_domain1  = "1.1"
  CHARACTER(len=*), PARAMETER :: str_domain2  = "1.1" 
