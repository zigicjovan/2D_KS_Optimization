...
#SBATCH --time=00-00:55		        # time (DD-HH:MM) or (HH:MM:SS)
#SBATCH --output=output_DNS_T200_dt1e-3_X1.1Y1.1_machepsnoise.out		# output file
#SBATCH --job-name=dnsT200x11y11           	# keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X1.1Y1.1_machepsnoise/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T200_dt1e-3_X1.1Y1.1_machepsnoise/
make clean
make type=DNS
