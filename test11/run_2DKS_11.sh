...
#SBATCH --output=output_DNS_T150_dt1e-3_X1.1Y1.1_machepssinN.out		# output file
#SBATCH --job-name=dnsT150x11y11           	# keep track of jobs

module load StdEnv/2020 fftw-mpi/3.3.8 netcdf-fortran-mpi/4.5.2
rm -rf /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T150_dt1e-3_X1.1Y1.1_machepssinN/
mkdir /home/zigicj/projects/def-bprotas/zigicj/2D_KS_Optimization/DNS_T150_dt1e-3_X1.1Y1.1_machepssinN/
make clean
make type=DNS
